<template>
  <button :class="isOpen ? 'roll-in-left' : 'roll-out-left'"
    class="z-40 fixed top-3 left-32" @click="isOpen = !isOpen">
<svg
...
>
  ...
  <div
      :class="isOpen ? 'swing-in-left-bck' : 'swing-out-left-fwd'"
      class="z-10 flex flex-col h-screen w-2/9.5 p-3 bg-gray-300 dark:bg-gray-800 shadow-md"
  >
      <div class="space-y-3">
